...
export type DistributerStockDocument = DistributerStock & Document;
...
const DistributerStockSchema = SchemaFactory.createForClass(DistributerStock);

DistributerStockSchema.index({ distributerId: 1, productId: 1 }, { unique: true }); //compound index

export { DistributerStockSchema };
